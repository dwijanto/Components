...
Public Class ExcelStuff
    ...
    Public Shared Sub ExportToExcel(ByRef FileName As String, ByVal DataSet1 As DataSet)
        ...
        If (DirectoryBrowser.ShowDialog() = Windows.Forms.DialogResult.OK) Then
            ...
            Try
                ...
                FileName = DJLib.Dbtools.ValidateFileName(DirectoryBrowser.SelectedPath, source)
                oWb.SaveAs(FileName)
                Result = True
            ...
            Finally
                ...
                oXl.Quit()
                oXl.Visible = True
                DJLib.Dbtools.releaseComObject(oSheet)
                DJLib.Dbtools.releaseComObject(oWb)
                DJLib.Dbtools.releaseComObject(oXl)
                GC.Collect()
    ...
    Public Shared Sub ExportToExcelAskDirectory(ByRef FileName As String, ByVal Sqlstr As String, ByVal dbTools As DJLib.Dbtools, Optional ByVal Location As String = "A1", Optional ByVal Template As String = "\templates\RawDataTemplate.xltx", Optional ByVal CreationDate As Boolean = False, Optional ByVal SheetNum As Integer = 1)
        'ask export location
        Dim DirectoryBrowser As FolderBrowserDialog = New FolderBrowserDialog
        DirectoryBrowser.Description = "Which directory do you want to use?"
        If (DirectoryBrowser.ShowDialog() = Windows.Forms.DialogResult.OK) Then
    ...
    Public Shared Function ExportToExcelFullPath(ByRef Filename As String, ByVal Dataset1 As DataSet) As Boolean
        ...
        Try
            ...
            'oRange.AutoFilter()
            oSheet.Cells.EntireColumn.AutoFit()
            Filename = DJLib.Dbtools.ValidateFileName(System.IO.Path.GetDirectoryName(source), source)
            oWb.SaveAs(Filename)
            result = True
            'FormMenu.setBubbleMessage("Export To Excel", "Done")
        Catch ex As Exception
    ...
    Public Shared Sub FillDataSource(ByRef owb As Excel.Workbook, ByVal SheetNum As Integer, ByVal sqlstr As String, ByVal dbtools As DJLib.Dbtools, Optional ByVal Location As String = "A1")

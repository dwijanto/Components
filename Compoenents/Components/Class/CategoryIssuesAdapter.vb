Imports Npgsql
Public Class CategoryIssuesAdapter
    ...
    Public Sub New()
        MyBase.new("select * from categoryissues;")
    ...
    Public Overloads Function saverecord(ByRef sender As Object, ByRef e As EventArgs) As Boolean
        ...
        Using conn As Object = myAdapter.getConnection
            ...
            'Update
            Dim sqlstr = "sp_updatecategoryissues"
            ...
            dataadapter.UpdateCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "catissues").SourceVersion = DataRowVersion.Current
            dataadapter.UpdateCommand.CommandType = CommandType.StoredProcedure

            sqlstr = "sp_insertcategoryissues"
            dataadapter.InsertCommand = myAdapter.getCommandObject(sqlstr, conn)
            dataadapter.InsertCommand.Parameters.Add("", NpgsqlTypes.NpgsqlDbType.Varchar, 0, "catissues").SourceVersion = DataRowVersion.Current
            ...
            sqlstr = "sp_deletecategoryissues"

...
Public Class FormABCSupplier
    ...
    Private Sub doWork()
        ...
        If myInsert.Length > 0 Then
            ...
            mystr.Append("delete from abcsupplier;")
            Dim sqlstr As String = "copy abcsupplier(suppliertype,vendorcode,process) from stdin with null as 'Null';"
            'mystr.Append(sqlstr)
            Dim ra As Long = 0

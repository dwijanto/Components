...
Public Class FormBrowseFolder
    ...
    Private Sub doLoad()
        ...
        Dim sqlstr As String = "select * from docemailhd where docemailtype = 0 and receiveddate >= " & DateFormatyyyyMMdd(startdate) & " and receiveddate <=  " & DateFormatyyyyMMdd(enddate) & "  order by receiveddate desc;" &
                                ...
                                " select d.* from docemaildt d left join docemailhd h on h.docemailhdid = d.docemailhdid  where docemailtype = 0 and h.receiveddate >= " & DateFormatyyyyMMdd(startdate) & " and h.receiveddate <= " & DateFormatyyyyMMdd(enddate) & ";"
        ...
        If DbAdapter1.TbgetDataSet(sqlstr, ds, mymessage) Then
            ...
            mybasefolder = ds.Tables(2).Rows(4).Item("cvalue") & "\FORWARDER\"
        Else

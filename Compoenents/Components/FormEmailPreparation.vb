...
Public Class FormEmailPreparation
        ...
        If MessageBox.Show(String.Format("Found {0} bill of lading(s) for {1}. Generate email draft?", distinctvalue.Rows.Count, IIf(selectedUser = "", "all SAO", selectedUser)), "Message", MessageBoxButtons.OKCancel) = DialogResult.OK Then
            ...
            Try
                ...
                For Each dr As DataRow In distinctvalue.Rows
                    ...
                    Dim mymsg As String = String.Empty
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        startdate = DateTimePicker1.Value
        enddate = DateTimePicker2.Value
        Dim myShowAllItemForm As New FormShowAllItems(username, password, selectedUser, startdate, enddate)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Dim mySendIndividualEmail As New FormSendIndividualEmail(username, password, selectedUser, startdate, enddate)

...
Public Class FormFamily
    ...
    Dim myController As FamilyController
    ...
    Public Sub New()
        ...
        InitializeComponent()
        AddHandler DialogFamily.RefreshData, AddressOf RefreshDataGrid
    ...
    Sub DoWork()
        myController = New FamilyController
    ...
    Public Sub showTx(ByVal tx As TXRecord)
        If Not myThread.IsAlive Then
            ...
            Dim myform = New DialogFamily(drv)

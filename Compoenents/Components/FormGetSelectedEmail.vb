...
Public Class FormGetSelectedEmail
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Not myThread.IsAlive Then
            ...
            'selecteddate = DateTimePicker1.Value.Date & " " & DateTimePicker2.Value.Hour & ":" & (DateTimePicker2.Value.Second - 1)
            'selecteddate2 = DateTimePicker1.Value.Date & " " & DateTimePicker2.Value.Hour & ":" & (DateTimePicker2.Value.Second + 1)
    ...
    Private Function GetFolder(ByVal offset As Integer) As Boolean
        ...
        Dim sqlstr = "select dt.* from paramdt dt" &
                    ...
                    " select distinct docemaildtname,docemailhdid,docemaildtid from docemaildt;"
        ...
        Using myservice As New ClassEWS(url, username, password, "as", False)
            ...
            Try
                ...
                Dim userMailbox = New Mailbox("sebshipdoc@groupeseb.com")
                ...
                For Each folder In results.Folders
                    ...
                    Else
                        ...
                        If folder.DisplayName.Contains("Forwarder") Or
                            ...
                            'searchFilterCollection.Add(New SearchFilter.IsEqualTo(ItemSchema.DateTimeReceived, DateTime.Parse(selecteddate.ToString)))
                            ...
                            'Dim searchfilteritem As SearchFilter = New SearchFilter.SearchFilterCollection(LogicalOperator.Or, searchFilterCollection.ToArray)
                            ...
                            For Each Item As Item In searchresult.Items
                                ...
                                If TypeOf Item Is EmailMessage Then
                                    ...
                                    If Item.HasAttachments Then
                                        ...
                                        Dim mydocemailname = DbAdapter1.validfilename(myarray(myarray.Count - 1).Trim)
            ...
            If Not IsNothing(ds2) Then
                ...
                If Not DbAdapter1.DocEmailTx2(Me, mye) Then
                ...
                Try
                    ...
                    'sqlstr = getsqlstr(mydate, "emaillastreceived")

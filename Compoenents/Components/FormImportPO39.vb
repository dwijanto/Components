...
Public Class FormImportPO39
    ...
    Sub DoWork()
        ...
        Dim MiroUserSB As New System.Text.StringBuilder
        ...
        Using objTFParser = New FileIO.TextFieldParser(OpenFileDialog1.FileName)
            With objTFParser
                ...
                DS.Tables(11).TableName = "mirouser"
                ...
                For i = 0 To mylist.Count - 1
                    ...
                    myrecord = mylist(i)
                    If i >= 0 And myrecord(11) = "" Then
                        Dim unitcost = myrecord(14) / myrecord(17)
                        postingdate = DbAdapter1.dateformatdotdate(myrecord(1))
                        ...
                        If postingdate >= startdate.Date AndAlso postingdate <= enddate.Date Then
                            ...
                            If Not myrecord(12) = "" Then
                                ...
                                If IsNothing(result) Then
                                    ...
                                    cmmfSB.Append(myrecord(12) & vbCrLf)
                                End If
                                ...
                                If IsNothing(result) Then
                                    ...
                                    cmmfpriceSB.Append(myrecord(12) & vbTab &
                                                       Year(startdate) & vbTab &
                                                       DbAdapter1.dateformatdot(myrecord(1)) & vbTab &
                                                       DbAdapter1.validdec(unitcost) & vbTab &
                                                       DbAdapter1.validlong(myrecord(3)) & vbTab &
                                                       DbAdapter1.dateformatdot(myrecord(1)) & vbTab &
                                                       DbAdapter1.validdec(unitcost) & vbTab &
                                                       DbAdapter1.validlong(myrecord(3)) & vbCrLf)
                                Else
                                    'update
                                    If result.Item(2) < postingdate Then
                                        ...
                                        updatecmmfpricesb.Append(String.Format("['{0}'::character varying,{1}::character varying,'{2}'::character varying,'{3}'::character varying]",
                                                             result.Item(3), DbAdapter1.dateformatdot(myrecord(1)), DbAdapter1.validdec(unitcost), DbAdapter1.validlong(myrecord(3))))
                                ...
                                If IsNothing(result) Then
                                    ...
                                    cmmfvendorpriceSB.Append(myrecord(12) & vbTab &
                                                       myrecord(19) & vbTab &
                                                       Year(startdate) & vbTab &
                                                       DbAdapter1.dateformatdot(myrecord(1)) & vbTab &
                                                       DbAdapter1.validdec(unitcost) & vbTab &
                                ...
                                Else
                                    ...
                                    If result.Item(3) < postingdate Then
                                        ...
                                        updateCMMFvendorpriceLastsb.Append(String.Format("['{0}'::character varying,{1}::character varying,'{2}'::character varying,'{3}'::character varying]",
                                                      result.Item(5), DbAdapter1.dateformatdot(myrecord(1)), DbAdapter1.validdec(unitcost), DbAdapter1.validlong(myrecord(3))))
                            ...
                            If IsNothing(result) Then
                                ...
                                MiroSB.Append(myrecord(3) & vbTab &
                                            DbAdapter1.dateformatdot(myrecord(1)) & vbTab &
                                            DbAdapter1.validchar(myrecord(6)) & vbTab &
                                            DbAdapter1.validlong(myrecord(19)) & vbCrLf)
                            Else
                            ...
                            If IsNothing(result) Then
                                ...
                                MiroUserSB.Append(myrecord(3) & vbTab &
                                                  validstr(myrecord(10)) & vbCrLf)
                            ...
                            If IsNothing(result) Then
                                ...
                                POHDSB.Append(myrecord(1) & vbTab &
                                                DbAdapter1.validchar(myrecord(7)) & vbTab &
                                                 DbAdapter1.validchar(myrecord(23)) & vbCrLf)
                            End If
                            ...
                            If IsNothing(result) Then
                                ...
                                dr.Item(1) = myrecord(9)
                                dr.Item(2) = podtlseq
                                DS.Tables(2).Rows.Add(dr)
                                podtlid = podtlseq
                                'pohd bigint, polineno character varying,cmmf bigint,oun character varying
                                PODtlSB.Append(myrecord(8) & vbTab &
                                               DbAdapter1.validint(myrecord(9)) & vbTab &
                                               DbAdapter1.validlongNull(myrecord(12)) & vbTab &
                                               DbAdapter1.validchar(myrecord(18)) & vbCrLf)
                            Else
                            ...
                            POMiroSB.Append(podtlid & vbTab &
                                                ...
                                                DbAdapter1.validdec(myrecord(17)) & vbTab &
                                                DbAdapter1.validchar(myrecord(15)) & vbTab &
                                                DbAdapter1.validdec(unitcost) & vbCrLf)
                        End If
                    End If
                Next
        ...
        Try
            ...
            If MiroUserSB.Length > 0 Then
                ProgressReport(2, "Copy MiroUser")
                'mironumber bigint ,miropostingdate date, supplierinvoicenum character varying, vendorcode bigint
                sqlstr = "copy mirouser(miro,username) from stdin with null as 'Null';"
                Dim errmessage As String = String.Empty
                Dim myret As Boolean = False
                errmessage = DbAdapter1.copy(sqlstr, MiroUserSB.ToString, myret)
                If Not myret Then
                    ProgressReport(2, "Copy MiroUser" & "::" & errmessage)
                    Exit Sub
                End If
            End If

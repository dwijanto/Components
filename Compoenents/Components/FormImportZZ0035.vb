    ...
    Sub DoWork()
                            ...
                            If Not myrecord(4) = "" Then
                                ...
                                If IsNothing(result) Then
                                    ...
                                    cmmfvendorpriceSB.Append(myrecord(4) & vbTab &
                                                             ...
                                                             DbAdapter1.validchar(myrecord(12)) & vbCrLf)
                                Else
                                    'update
                                    If result.Item(3) <= postingdate Then
                                        ...
                                        updateCMMFvendorpriceLastsb.Append(String.Format("['{0}'::character varying,{1}::character varying,'{2}'::character varying,'{3}'::character varying,'{4}'::character varying]",
                                                      result.Item(5), DbAdapter1.dateformatdot(myrecord(11)), DbAdapter1.validdec(myrecord(16)), DbAdapter1.validlong(myrecord(10)), DbAdapter1.validchar(myrecord(12))))
                                    End If

                                    If result.Item(4) >= postingdate Then
                                        ...
                                        End If
                                        result.Item("initialtx") = postingdate
                                        updateCMMFvendorpriceInitsb.Append(String.Format("['{0}'::character varying,{1}::character varying,'{2}'::character varying,'{3}'::character varying,'{4}'::character varying]",
                                                           result.Item(5), DbAdapter1.dateformatdot(myrecord(11)), DbAdapter1.validdec(myrecord(16)), DbAdapter1.validlong(myrecord(10)), DbAdapter1.validchar(myrecord(12))))
        ...
        Try
            ...
            If cmmfvendorpriceSB.Length > 0 Then
                ...
                'cmmf,myyear,initailtx,initialprice,incoiceverificationnumber,lasttx,lastprice,invoiceverificationnumber2
                sqlstr = "copy cmmfvendorprice(cmmf,vendorcode,myyear,initialtx,initialprice,invoiceverificationnumber,lasttx,lastprice,invoiceverificationnumber2,initcurr,lastcurr) from stdin with null as 'Null';"
                Dim errmessage As String = String.Empty
                Dim myret As Boolean = False
            ...
            If updateCMMFvendorpriceLastsb.Length > 0 Then
                ...
                'lasttx,lastprice,invoiceverificationnumber2
                sqlstr = "update cmmfvendorprice set lasttx= foo.lasttx::date,lastprice = foo.lastprice::numeric,invoiceverificationnumber2 = foo.invoiceverificationnumber2::bigint,agv2 = 0 ,lastcurr = foo.curr::character varying from (select * from array_to_set5(Array[" & updateCMMFvendorpriceLastsb.ToString &
                         "]) as tb (id character varying,lasttx character varying,lastprice character varying,invoiceverificationnumber2 character varying,curr character varying) order by id,lasttx )foo where cpid = foo.id::bigint;"
                Dim ra As Long
                If Not DbAdapter1.ExecuteNonQuery(sqlstr, ra, errmsg) Then
            ...
            If updateCMMFvendorpriceInitsb.Length > 0 Then
                ...
                'lasttx,lastprice,invoiceverificationnumber2
                sqlstr = "update cmmfvendorprice set initialtx= foo.inittx::date,initialprice = foo.initialprice::numeric,invoiceverificationnumber = foo.invoiceverificationnumber::bigint ,initcurr = foo.curr::character varying from (select * from array_to_set5(Array[" & updateCMMFvendorpriceInitsb.ToString &
                         "]) as tb (id character varying,inittx character varying,initialprice character varying,invoiceverificationnumber character varying,curr character varying))foo where cpid = foo.id::bigint;"
                Dim ra As Long
                If Not DbAdapter1.ExecuteNonQuery(sqlstr, ra, errmsg) Then
            ...
            If POMiroSB.Length > 0 Then
                ...
                End If
            End If
            DbAdapter1.getproglock("FormImportZZ0035", HelperClass1.UserInfo.DisplayName, 0)

...
Public Class FormLogBook
    ...
    Sub DoWork()
        ...
        '                                 " ) foo inner Join " &
        '                                 " (select pohd,poitem,max(plh.delivery)::character varying as delivery,max(deliveryitem) as deliveryitem,housebill" &
        '                                 " from packinglisthd plh" &
        '                                 " left join packinglistdt pld on plh.delivery = pld.delivery" &
        '                                 " group by pohd,poitem,housebill" &
        '                                 " having(count(pohd) = 1)" &
        ...
        '                                 " order by pohd,poitem ) foo2 on foo2.pohd::character varying = foo.pohd and foo2.poitem = foo.polineno" &
        '                                 " order by docno;"
        'Dim sqlstrAccountingPartial = "select foo.docno::character varying,myyear,postingdate,username,reference,mironumber::character varying,foo.pohd::character varying,polineno,cmmf::character varying,qty,amount,crcy,exrate,vendorcode::character varying,vendorname::character varying,delivery::character varying,item as deliveryitem,housebill from " &
        ...
        '                                " inner Join" &
        '                                " (select pohd,poitem,housebill " &
        '                                " from packinglisthd plh " &
        '                                " left join packinglistdt pld on plh.delivery = pld.delivery " &
        '                                " group by pohd,poitem,housebill having(count(pohd) > 1) " &
        '                                " order by pohd,poitem ) foo2 on foo2.pohd::character varying = foo.pohd and foo2.poitem = foo.polineno " &
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If DbAdapter1.TbgetDataSet(sqlstr, myds, mymessage) Then
            ...
            myds.Tables(1).TableName = "Billing Doc Header Matching"
    ...
    Private Sub ToolStripButton9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton9.Click
        Dim myform As New FormEmailPreparation
        myform.Show()
    End Sub
    ...
    Private Sub ToolStripButton18_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton18.Click
        Dim myform As New FormEmailPreparationCP
        myform.Show()
    End Sub

...
Public Class FormReportKPIPivot
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (DirectoryBrowser.ShowDialog() = Windows.Forms.DialogResult.OK) Then
            ...
            Dim reportname = "KPI Graph" '& GetCompanyName()
            Dim mycallback As FormatReportDelegate = AddressOf FormattingReport
            Dim PivotCallback As FormatReportDelegate = AddressOf PivotTable
            Dim datasheet As Integer = 4
            Dim myreport As New ExportToExcelFile(Me, sqlstr, filename, reportname, mycallback, PivotCallback, datasheet, "\\172.22.10.77\Users_I\Logistic Dept\KPI & Reporting\templates\KPI Graph Final.xltx")
            myreport.Run(Me, e)
        End If
    ...
    Private Sub PivotTable(ByRef sender As Object, ByRef e As EventArgs)
        ...
        osheet.PivotTables("L1_SUPPLIER/FW").PivotCache.Refresh()
        osheet.PivotTables("L3_Supplier/FW").PivotCache.Refresh()
        osheet.PivotTables("L2_REASONS for SASL FAILED").PivotCache.Refresh()
        osheet.PivotTables("L4_REASONS for SASL FAILED").PivotCache.Refresh()
        osheet.PivotTables("New Item").PivotCache.Refresh()

...
Public Class FormSAOSIS
    ...
    Private Sub doLoad()
        ...
        Dim sqlstr = "select vs.vendorcode,v.vendorname::character varying,vs.saoname,vendorsaosisid from vendorsaosis vs left join vendor v on v.vendorcode = vs.vendorcode order by vs.vendorcode;" &
                     "select vendorcode,vendorname from vendor order by vendorcode;"
        ...
        If DbAdapter1.TbgetDataSet(sqlstr, ds, mymessage) Then
            ...
            idx0(0) = ds.Tables(0).Columns("vendorsaosisid")
            ds.Tables(0).PrimaryKey = idx0

            ds.Tables(0).Columns("vendorsaosisid").AutoIncrement = True
            ds.Tables(0).Columns("vendorsaosisid").AutoIncrementSeed = 0
            ds.Tables(0).Columns("vendorsaosisid").AutoIncrementStep = -1
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.vendorsaosis(Me, mye) Then
    ...
    Private Sub ToolStripButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton6.Click
        Dim myform As New FormImportSAOSIS
        myform.ShowDialog()
        Me.LoadData()
    End Sub
    ...
    Private Sub ToolStripButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton7.Click
        Dim filename As String = "VendorSISSAO-" & Format(DateTime.Today, "yyyyMMdd") & ".xlsx"
        Dim dbtools = New Dbtools
        dbtools.Userid = "admin"
        dbtools.Password = "admin"
        Dim sqlstr = "select vs.vendorcode,v.vendorname,vs.saoname from vendorsaosis vs left join vendor v on v.vendorcode = vs.vendorcode order by v.vendorname;"

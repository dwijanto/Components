...
Public Class FormVendorSPComp
    ...
    Private Sub doLoad()
        ...
        Dim sqlstr = "select vp.vendorcode,v.vendorname::character varying,upper(vp.sp) as sp from vendorspcomp vp" & _
    ...
    Private Sub ToolStripButton4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton4.Click
        ...
        If Not IsNothing(ds2) Then
            ...
            If DbAdapter1.VendorSPComp(Me, mye) Then
    ...
    Private Sub ToolStripButton6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton6.Click
        Dim myform As New VendorSPComp
        myform.Show()
        Me.LoadData()
    End Sub
    ...
    Private Sub ToolStripButton7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripButton7.Click
        ...
        Dim sqlstr = "select v.vendorcode,v.vendorname,upper(sp) as sp from vendorspcomp vp" & _
                 " left join vendor v on v.vendorcode = vp.vendorcode" & _
                 " order by vendorname,sp "
